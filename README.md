...
Проект "Бнковские операции" - это виджет на Python, 
...
```
 git clone https://https://github.com/Emilyen31/homerwork
```
...
Фильтрует список операций по статусу выполнения ('EXECUTED')
